...
<li><a href="BarnchLocation.php">Branch Address</a></li>
</ul>
</div>
</li>
...
<li><a href="Downloads.php">Downloads</a></li>
               ...
               <div class="Smi"> 
		             ...
		             <ul>
					   <li><a href="https://www.facebook.com/groups/745701727261471"><i class="fa fa-facebook"></i></a></li>
		               <li><a href="https://twitter.com/Harbu25136"><i class="fa fa-twitter"></i></a></li>
                       <li><a href="Shttps://www.linkedin.com/feed/?trk=nav_logo"><i class="fa fa-linkedin"></i></a></li>
					   <li><a href="http:t.me/Harbu MFI"><i class="fa fa-telegram"></i></a></li>
					   <li><a href="http:youtube.com/HarbuMFI"><i class="fa fa-youtube"></i></a></li>
                   </ul>
                  </div>
...
<p>Urban agriculture has recently gained attention in many developing countries following their rapid urbanization.
This paper attempts to give an overview of urban agriculture in Ethiopia. It particularly synthesizes the existing evidence
on the role of urban agriculture in the overall agricultural sector, urban economy, and urban employment based on data
from official reports and statistical surveys. Albeit being scant, the available evidence shows that urban agriculture makes
considerable contributions, particularly, seen in light of the low level of urbanization in the country. The review however
reveals there exist gaps in terms of institutional and policy support for urban agriculture. The paper, therefore, tries to
shed lights on the current and expected socio-economic trends that will raise the relevance of the sector. Future research,
especially, on the macroeconomic aspects of the sector are highly needed. Such research and evidence will help decisionand policy-makers to embrace the concept of urban agriculture in formulating sectoral, regional, and national economic
policies.</p>
